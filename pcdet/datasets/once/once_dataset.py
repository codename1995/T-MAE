...
class ONCEDataset(DatasetTemplate):
    def __init__(self, dataset_cfg, class_names, training=True, root_path=None, logger=None):
        ...
        # | -------------- | ------------- | ---------- | ---------- |
        # | pre-train      | True           | 'train'    | 'raw_large' |
        ...
        # * self.split depends on pre-define in yaml file or self.set_split()
        #   (self.set_split is only called by self.create_waymo_infos())
        ##############################
...
def create_once_infos(dataset_cfg, class_names, data_path, save_path, workers=32):
    ...
    ignore = ['test', 'raw_small', 'raw_medium']
