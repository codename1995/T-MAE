...
class Detector3DTemplate(nn.Module):
    ...
    def build_backbone_2d(self, model_info_dict):
        ...
        if model_info_dict.get('num_bev_features', None) is None and hasattr(self.model_cfg.BACKBONE_2D, 'NUM_BEV_FEATURES'):
            num_bev_features = self.model_cfg.BACKBONE_2D.NUM_BEV_FEATURES
            model_info_dict['num_bev_features'] = num_bev_features
    ...
    def load_params_with_optimizer(self, filename, to_cpu=False, optimizer=None, logger=None, scaler=None):
        if not os.path.isfile(filename):
            raise FileNotFoundError
