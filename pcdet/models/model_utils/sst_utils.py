...
def get_window_coors(coors, sparse_shape, window_shape, do_shift):
    ...
    Args:
        ...
        sparse_shape: (3, ) [0.32, 0.32, 6] for waymo
        window_shape: (3, ) [8, 8, 1] for waymo
        do_shift: bool
    Returns:
        batch_win_idxs: (N, ), the identical window index of each voxel
        coors_in_window: (N, 3) [z_idx, y_idx, x_idx], the coors of each voxel in its window
        win_grid_size: (3, ), the number of windows in each dimension
    """
