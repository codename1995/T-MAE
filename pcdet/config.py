...
# def update_config_wo_override(config, new_config):
#     for key, val in new_config.items():
#         if not isinstance(val, dict):
...
#         if key not in config:
#             config[key] = EasyDict()
#         config[key] = update_config_wo_override(config[key], val)
#
#     return config
...
# def load_base_config(base_config_path, config):
#     base_cfg = EasyDict()
#     base_cfg = cfg_from_yaml_file(base_config_path, base_cfg)
#     # config = update_config_wo_override(config, new_config=base_cfg)
#     base_cfg = base_cfg.update(config)
#     config = merge_new_config(config, new_config=base_cfg)
#     return config
